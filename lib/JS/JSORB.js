...
JSORB.Client.prototype.new_request = function (p) {
    // NOTE:
    // we should really be catching possible
    // JSON parse errors here, but since
    // you are likely creating the requests
    // that are sent, you should make sure
    // that the code is good. It is more the
    // responses that we need to worry about
...
JSORB.Client.prototype.__call = function (request, callback, error_handler) {
    ...
    options.error    = function (request, status, error) {
        var resp;
        // catch errors in the building of a
        // response, in particular JSON errors
        try {
    ...
    options.success  = function (data, status) {
        ...
        try {
            ...
            resp = new JSORB.Client.Response(data);
...
JSORB.Client.Request = function (p) {
    ...
    this.params = p['params'] && typeof p['params'] == 'string'
                    ? JSORB.Util.parse_JSON(p['params'])
                    : p['params'];
}
...
JSORB.Client.Request.prototype.as_url = function (base_url) {
    ...
    params.push('method=' + encodeURIComponent(this.method));
    if (this.params) {
        params.push('params='  + encodeURIComponent(JSORB.Util.render_as_JSON(this.params)));
    }
...
JSORB.Client.Request.prototype.as_json = function () {
    return JSORB.Util.render_as_JSON(this.collapse_for_json());
}
...
JSORB.Util.parse_JSON = function (json) {
    return JSON.parse(json);
}

JSORB.Util.render_as_JSON = function (data) {
